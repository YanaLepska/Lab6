...
namespace ClassLib_1
{
    public class CPU
    {
        ...
        ////////////////////
        public string[] GetInfoForDGV()
        {
            string[] output = new string[10];

            output[0] = Convert.ToString(description.Name);
            output[1] = Convert.ToString(description.Freq);
            output[2] = Convert.ToString(description.Phy_Cores);
            output[3] = Convert.ToString(description.Log_Cores);
            output[4] = Convert.ToString(description.Manufacturer);
            output[5] = Convert.ToString(description.Socket);
            output[6] = Convert.ToString(description.L1Chache);
            output[7] = Convert.ToString(description.L2Chache);
            output[8] = Convert.ToString(description.L3Chache);
            output[9] = Convert.ToString(description.Price);
